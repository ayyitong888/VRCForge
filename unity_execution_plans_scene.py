...
def build_scene_execution_plan(target_name: str, arguments: dict[str, Any]) -> list[tuple[str, dict[str, Any]]]:
    ...
    gameobject_tools = {
        ...
        "vrcforge_delete_gameobject": ("vrc_delete_gameobject", lambda: {"gameObjectPath": _gameobject_target(params), "preview": False}),
