...
| VRCForge MCP 2.0 Core | Self-contained Unity package, MCP 2.0 (`2026-07-28`), fixed 78-tool contract in v1.7.8 | Clean import, direct App connection, `tools/list`, approval/checkpoint/write/readback/restore/reconnect evidence | No external Unity MCP runtime is required; the Unity Core remains `2026-07-28` only |
