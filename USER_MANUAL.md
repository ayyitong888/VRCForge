...
(`v1.7.8`). The 1.7.10 target keeps internal Agent and external MCP tool results
...
- `v1.7.10` 的 `VRCForge.unitypackage`，包含 VRCForge 自有 MCP 2.0 Core（`2026-07-28`）和 82 个声明的 Unity 工具
- 用于 AI 辅助功能的模型服务账号
