...
![当前版本](https://img.shields.io/badge/当前版本-v1.8.6-d9487c?style=flat-square)
...
当前源码目标为 v1.8.6，尚未正式发布。最新稳定版为 [v1.8.5](https://github.com/ayyitong888/VRCForge/releases/tag/v1.8.5)。
安装与升级请获取同一 Release 的配套安装器与 Unity 包。

**[下载 VRCForge v1.8.5](https://github.com/ayyitong888/VRCForge/releases/tag/v1.8.5)** · [查看 Release Notes](docs/RELEASE_NOTES_1.8.5.md)
...
- 1.8.6 请使用 `VRCForge_Web_Installer_x64.exe`，或离线安装器 `VRCForge_Offline_Installer_x64.exe`
...
- `v1.8.6` 的发布状态请以 Releases 页面为准；协议、源码测试或工具调用成功仍不能替代具体模型的视觉与恢复验收。
- Quest/Android、第三方资产许可和付费依赖由具体 Avatar 与资源决定。

## 文档入口

- [用户手册 / User Manual](USER_MANUAL.md)
- [v1.8.6 版本说明](docs/RELEASE_NOTES_1.8.6.md)
