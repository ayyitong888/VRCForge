...
const bundle = await build({ stdin: { resolveDir: process.cwd(), loader: "tsx", contents: `
 ...
 function Fixture(){const [key,setKey]=useState(""); const [model,setModel]=useState("m"); const [passed,setPassed]=useState(false);
  const hook=useProviderSettings({endpoint:location.origin,runtimeConnected:true,apiConfig:{provider:"custom",base_url:"",model:"m",api_type:"auto",apiKeyRequired:true,apiKeyPresent:true},startRuntime:async()=>location.origin,refresh:async()=>{},setError:()=>{}});
