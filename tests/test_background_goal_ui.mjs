...
const runSingleTurnStart = runController.indexOf("async function runSingleTurn");
const runSingleTurnCatch = runController.indexOf("} catch (cause) {", runSingleTurnStart);
const backgroundCatchStart = runController.indexOf("if (background) {", runSingleTurnCatch);
