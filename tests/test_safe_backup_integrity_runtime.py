...
def test_restore_rejects_damaged_backup_before_writing(tmp_path, damaged):
...
class VRCForgeToolResult {public bool Success;public string Message;public static object Completed(string m,object p)=>new VRCForgeToolResult{Success=true,Message=m};public static object Failed(string m,object p=null)=>new VRCForgeToolResult{Success=false,Message=m};}
class Probe {
