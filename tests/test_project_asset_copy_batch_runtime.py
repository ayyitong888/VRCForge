...
def test_actual_copy_batch_handler_faults(tmp_path):
    ...
    seam=r'''
namespace UnityEngine {class Object {internal string name="name";internal int hideFlags;internal bool main;} class Material:Object {}}
...
namespace UnityEditor {
 ...
 static class AssetDatabase {
  internal static int Count, FailAt, Saves;internal static bool SaveFails, UnknownOnFailure;internal static string Drift="",LayoutMode="";
  ...
  internal static void SaveAssets(){Saves++;if(SaveFails)throw new InvalidOperationException("save failed");}
...
namespace VRCForge.Editor {
 ...
 public class Runner {
  ...
  public static int Main(){
   Reset();var result=Run(Seal(Request()));Check(result["verified"].Value<bool>()&&SceneObjectCopyCore.Files.Count==2&&UnityEditor.AssetDatabase.Saves==1,"one save successful batch");
...
'''
    ...
    assert result.stdout.count("PASS ")==29
