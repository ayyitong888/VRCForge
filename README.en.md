...
![Current version](https://img.shields.io/badge/current-v1.8.5-d9487c?style=flat-square)
...
This page describes the published [v1.8.5 stable release](https://github.com/ayyitong888/VRCForge/releases/tag/v1.8.5).
Get matching installers and Unity packages from that same Release.

**[Download VRCForge v1.8.5](https://github.com/ayyitong888/VRCForge/releases/tag/v1.8.5)** · [Read the Release Notes](https://github.com/ayyitong888/VRCForge/releases)
...
- For 1.8.5, use `VRCForge_Web_Installer_x64.exe`, or `VRCForge_Offline_Installer_x64.exe` for an offline install.
...
- [v1.8.5 stable release notes](docs/RELEASE_NOTES_1.8.5.md)
