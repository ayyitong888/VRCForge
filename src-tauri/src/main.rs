...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            consume_session_handoff_context,
            ...
            fetch_official_skill_signing_key,
            ...
            export_official_skill_signing_key,
            import_official_skill_signing_key,
            ...
            request_chat_attachment_import,
