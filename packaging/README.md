...
the `v1.7.6` package. The public repo must not contain encryption
...
powershell -NoProfile -ExecutionPolicy Bypass -File packaging\build_release.ps1 `
  -Version 1.7.6 `
  -PayloadDownloadUrl https://github.com/ayyitong888/VRCForge/releases/download/v1.7.6/VRCForge_Windows_x64_1.7.6.zip `
...
pointers when they exist in the checkout. For the current `1.7.6` target release,
