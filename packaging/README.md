...
The current source / target package is `1.7.10` (`v1.7.10`). `1.7.8` remains the latest published stable package
...
the `v1.7.10` package. The public repo must not contain encryption
...
powershell -NoProfile -ExecutionPolicy Bypass -File packaging\build_release.ps1 `
  -Version 1.7.10 `
  -PayloadDownloadUrl https://github.com/ayyitong888/VRCForge/releases/download/v1.7.10/VRCForge_Windows_x64_1.7.10.zip `
...
pointers when they exist in the checkout. For the current `1.7.10` target release,
