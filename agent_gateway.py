...
BUILTIN_SKILL_GROUPS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "outputs": ["Project file deltas, affected scanner families, and outfit package structural summaries."],
        "sideEffects": "updates local VRCForge index only; reads package directory/pathname metadata only",
        "backupRestore": "not required",
        "allowedTools": ["vrcforge_scan_project_index", "vrcforge_inspect_outfit_package"],
